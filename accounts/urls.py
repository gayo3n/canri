...
from.views import account_login, account_create, account_create_complete,manage_account
...
urlpatterns = [
    ...
    path('management_account/account_creating/account_create_complete/', views.account_create_complete, name='account_create_complete'),  
